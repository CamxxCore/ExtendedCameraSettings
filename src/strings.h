...
static LPCTSTR pt_br[] {
    ...
    u8"Sempre Exibir a Mira (Primeira Pessoa)",
    ...
    u8"Centralizar Automaticamente a Câmera (Terceira Pessoa)",
    ...
    u8"Tremer a Câmera ao Correr (Terceira Pessoa)",
    ...
    u8"Campo de Visão da Câmera do Veículo (Primeira Pessoa)",
    u8"Origem Vertical da Câmera do Veículo (Primeira Pessoa)",
    ...
    u8"Ângulo Mínimo da Câmera do Veículo (Primeira Pessoa)",
    u8"Ângulo Máximo de Inclinação da Câmera do Veículo (Primeira Pessoa)",
    u8"Campo de Visão da Câmera do Veículo (Terceira Pessoa)",
    u8"Ângulo Mínimo da Câmera do Veículo (Terceira Pessoa)",
    u8"Ângulo Máximo da Câmera do Veículo (Terceira Pessoa)",
    u8"Centralizar Automaticamente a Câmera do Veículo (Terceira Pessoa)",
    u8"Distância da Câmera do Veículo (Terceira Pessoa)",
    u8"Distância da Câmera do Veículo em Alta Velocidade (Terceira Pessoa)",
    u8"Altura da Câmera do Veículo (Terceira Pessoa)",
    u8"Origem Horizontal da Câmera do Veículo (Terceira Pessoa)",
    u8"Tremer a Câmera do Veículo em Alta Velocidade (Terceira Pessoa)"
};
